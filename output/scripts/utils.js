 ...
 */ function randomImage({ size, ...params } = {}) {
...
/** calculates the device pixel per inch */ function getPPI() {
...
/** wrap the value in min-max boundary */ function wrap(val, min, max) {
 ...
 * @param {string} prefix
 * @returns
 */ function randomID(length = 6, prefix = '') {
  let result = '';
